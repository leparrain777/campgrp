...
!-------------------------------!
     ...
     &     ,alpha_s ,alpha_L, alpha_C, TEND, TBEG
     &     ,C_p,rho0, a_ocn, a_lnd, V_ocn
     ...
     &     ,initial_ice=5*(2000.e3)**2*2.e3       ! m^3
     ...
     &     ,P_0=0.03*Sv                           ! Sv, precipitation parameterization
     &     ,P_1=20.0                              ! nondim, precipitation parameterization
     &     ,delta=0.2                             ! nondim, precipitation parameterization
     &     ,S_0=0.075*Sv                          ! m^3/sec, ablation parameterization
     &     ,S_Milan_input=0.04*Sv                 ! m^3/sec, ablation parameterization
     &     ,S_Temperature=0.00075*Sv              ! m^3/sec, ablation parameterization
