function IceAge_lyapscan_QP_19_6pa
%%
...
ttrans=-60; 
tmax=4000;  % for integrated summer forcing, need tmax-ttrans < 5000
...
switch p.forcing
    ...
    case 3
        ...
        F2=(p.dcwcoeffs(16:33,2).*sin(p.dcwcoeffs(16:33,1)*t)+p.dcwcoeffs(16:33,3).*cos(p.dcwcoeffs(16:33,1)*t));
        FO=p.kt1*sum(F1)+p.kt2*sum(F2);
    otherwise
end % switch p.forcing
