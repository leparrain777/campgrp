...
filePath = '/nfsbigdata1/campgrp/zgelber/ProjectOutput/ClusterGrid/';  %Choose where you want to your output.

% ================================ %

    run_amount = 100;
    
    force_amplitude_begin = 0;          %Choose what force amplitude you would like to use.
    force_amplitude_end = 2;
    force_amplitude_steps = 1;

    tau_begin = 0.3;                    %Choose what value of tau you would like to use.
    tau_end = 1.5;
    tau_steps = 0.5;
