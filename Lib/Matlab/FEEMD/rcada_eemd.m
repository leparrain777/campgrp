...
%
% Usage: 
% (A) [allmode]=rcada_eemd(Y, NoiseLevel, NE, numImf)
% (B) [allmode]=rcada_eemd(x,NoiseLevel,NE,numImf,runCEEMD,maxSift,typeSpline,toModifyBC,randType,seedNo,checkInput);
%---------------------------------------------------------------
% INPUTS : 
%        Y: input signal
