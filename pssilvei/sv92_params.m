...
params.alphanot = params.alphaone - params.alphatwo * (tanh(params.c * params.munot) + params.kappatheta * params.thetanot + params.kappaR * .5 *(params.Rnot - params.Rstar)) - params.alphathree * params.Istar;
