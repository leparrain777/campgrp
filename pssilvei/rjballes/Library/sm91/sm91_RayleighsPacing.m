% A comparison of pacing of sm91 model output with a particular forcing signal
% 
clf
printflg = 0;
sm91_params
...
suptitle(sprintf('SM91 Run %g Ice Output vs Obliquity for u = %g, p = %g',runID,param(3),param(1))); 
