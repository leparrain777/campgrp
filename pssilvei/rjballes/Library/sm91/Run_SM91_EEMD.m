...
fileName = sprintf('SM91_Run%d_EEMD.txt',run_num); % edit for whatever variable stores your run number 
storeData(nmodes,fileName,filePath,size(nmodes,2));% Assuming you already have access to this script

if EEMDFigFlag == 1
    sm91_plot_eemd(nmodes,[1:size(nmodes,2)],1);
end
