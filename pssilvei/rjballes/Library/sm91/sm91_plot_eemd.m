function sm91_plot_eemd(nmodes,mode_num,saveFlag)
%sm91_plot_eemd(nmodes,mode_num,whiteNoise,runID,saveFlag)
...
title(sprintf('SM91 Run%d EEMD; p = %g, u = %g, %g White Noise',runID,param(1),param(3),whiteNoise));

if saveFlag
   fpath = '~/campgrp/rjballes/EEMDRuns/sm91/Figures/';
   fname0 = sprintf('sm91_run%d_EEMD',runID);
