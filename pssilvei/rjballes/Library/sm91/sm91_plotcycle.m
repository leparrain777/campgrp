function sm91_plotcycle(runID,descr,cycleNum1,cycleNum2)
...
%
% Example:  sm91_plotcycle(5,'insolLaskar',5);

fileName = sprintf('SM91_%s_%d_Model.txt',descr,runID);
filePath = '/nfsbigdata1/campgrp/rjballes/ModelRuns/sm91/';
[data,fullMat,iceMat] = sm91_find_cycles(fileName,filePath);  % May have to edit this script to adjust for size of data file
