...
%nmodesModel = readData('SM91_EEMD_Data.txt','/nfsbigdata1/campgrp/agallati/sm91/TheAllTuned/',11);
...
statFileName = 'DO18_Stats_.txt';
statFilePath = '/nfsbigdata1/campgrp/agallati/DO18Statistics/';
statFigPath = '/nfsbigdata1/campgrp/agallati/DO18Statistics/';
...
oblCutoffE = 1250; % length of cross correlation with obliquity early and late
oblCutoffL = 1250;
EccCutoff = 1250; % length of cross correlation with modified eccentricity late
varCutoff = 750; % length of signal used in variance ratios
