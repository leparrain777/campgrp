...
nmodesModel = readData('sm91eemdout.txt','/nfshome/rjballes/Lib/Matlab/sm91/TheOriginal/',11);
nmodesModel = nmodesModel(2:end,:);

StatFlag = 0; % if you want the stats output to the command line
FigFlag = 1; % if you want the figures plotted
FileSaveFlag = 0; % if you want the stats saved based on the file names/paths
FileSaveFlag2 = 0; % for use with Huybers averaging
FigSaveFlag = 0; % if you want the figures saved as pdf's

statFileName = 'SM91_Orig_Stats.txt';
%statFilePath = '/nfsbigdata1/campgrp/agallati/sm91/TheOriginal/';
%statFigPath = '/nfsbigdata1/campgrp/agallati/sm91/TheOriginal/';
statFilePath = '/nfshome/rjballes/Lib/Matlab/sm91/TheOriginal/';
statFigPath = '/nfshome/rjballes/Lib/Matlab/sm91/TheOriginal/';
...
ModelName = 'Saltzman and Maasch (Paper)';
