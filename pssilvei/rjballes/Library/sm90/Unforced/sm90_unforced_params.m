% This is the parameters file for running sm90 unforced model
...
timeflag = 1;  %control temporal plot of solutions
paramflag = 0;  %control plot of parameters

% Storing Data info
%fileName = sprintf('SM90_Unforced_p=%g_Model.txt',p);
fileName2 = sprintf('SM90_Unforced_Model_Full.txt');
