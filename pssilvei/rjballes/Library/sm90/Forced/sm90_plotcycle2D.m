function sm90_plotcycle2D(runID,descr,cycleNum1,cycleNum2)
...
for cycleNum=cycleNum1:cycleNum2
   ...
   plot(Mu(t1:t2),I(t1:t2),'r-','LineWidth',1.5)
   plot(Mu(t2:t3),I(t2:t3),'b-','LineWidth',1.5)
...
%plot(0,0,'k.','MarkerSize',20)
   ...
   text(Mu(t1),I(t1),strmin1);
   text(Mu(t2),I(t2),strmax);
   text(Mu(t3),I(t3),strmin2);
