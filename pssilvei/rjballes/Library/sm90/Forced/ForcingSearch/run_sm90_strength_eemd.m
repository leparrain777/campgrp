...
descr = 'insolLaskar'
%fileReadName = sprintf('SM90_%s_%d_Model.txt',descr,runID);
%fileReadPath = '~/campgrp/rjballes/ModelRuns/sm90/Forced/';
fileReadName = sprintf('SM90_%s_%d_forcing_Model.txt',descr,runID);
