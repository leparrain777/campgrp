...
Xprime = Y.*-2.8e13-X.*1.0e-4-Z.*3.08e14+(((X.*3.635041802980734e-4+1.09051254089422e16).^(1.0./5.0).*(1.0./3.0)<W)&(4.0<W)).*((X+3.0e19).*1.0./(X.*3.635041802980734e-4+1.09051254089422e16).^(1.0./5.0).*-2.0e1)+1.117284215276729e15;
Yprime = Z.*(-5.6e-3)-Y.*(Y.*1.1e-6+Y.^2.*3.6e-8-1.3e-4);
Zprime = X.*(-1.2e-23)-Z.*2.5e-4-1.2e-4;
Wprime = W.*(-3.333333333333333e-5)+(X+3.0e19).^(1.0./5.0).*2.279603801209383e-6;
