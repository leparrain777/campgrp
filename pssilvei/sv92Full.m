...
Xprime = (f*90-452)*-7.7e+13-Y.*2.8e+13-X./1.0e+4-Z.*3.08e+14+((nthroot(X./2.751e+3+1.09051254089422e+16,5)./3.0<W)&(4.0<W)).*((X+3.0e+19).*1.0./nthroot(X./2.751e+3+1.09051254089422e+16,5).*-2.0e+1)-3.353271578472327e+16;
