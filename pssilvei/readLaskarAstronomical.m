function [time, ecc, obl, prec, NorthF] = readLaskarAstronomical(tstart, tend)
...
%        [time, ecc, obl, prec, NorthF] = readLaskarAstronomical(t1,t2)
% To call a read for the whole data file:
%        [time, ecc, obl, prec, NorthF] = readLaskarAstronomical(0,5000)
%
% Author: Brian Knight
% Created: 07/30/18
% Last Edit: 08/07/18

fname = 'LaskarAstronomical5000.txt';
fpath = 'Data/Paleo/';
